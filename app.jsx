...
function ScoreHistoryPanel({p, sfm, setSfm, addScore, delScore, addWelledLog, delWelledLog}){
  ...
  /* Editorial threshold palette — sage / mustard / oxblood with matching tints */
  ...
  /* Inline progress bar — visual percentage representation for data-dense rows */
  const PctBar = ({value, width=72, inline=false})=>{
